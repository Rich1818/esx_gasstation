...
Config.Fuel_Price = 2.0 -- Default Fuel Price / liter

Config.Gas_Station_Price = 1000000 -- Default Gas Station Price

Config.Petrol_Can_Price = 500 -- Default Petrol Can price (empty)

Config.Fuel_Max_Price = 60 -- Max price of Fuel

Config.Petrol_Can_Max_Price = 500 -- Max price of Empty Petrol Can 

Config.fuel_import_price = 1  -- Fuel Price for Gas Station Owner

Config.can_import_price = 1 -- Petrol Can Price for Gas Station Owner
